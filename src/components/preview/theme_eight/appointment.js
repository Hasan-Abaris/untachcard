...
export default function AppointmentPage({ data, themeBg, cardBg, fontColor, cardFont }) {
  ...
  return (
    <>
      {loader && <Loader />}
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: themeBg }}>
        <div
          className="w-full max-w-lg rounded-xl shadow-xl p-6 relative"
          style={{ background: cardBg, color: fontColor, fontFamily: cardFont }}
        >
          {/* Header */}
          <h2 className="text-2xl font-semibold text-center mb-2" style={{ color: fontColor, fontFamily: cardFont }}>
            Appointment
          </h2>
          <p className="text-center mb-4" style={{ color: fontColor, fontFamily: cardFont }}>
          ...
          <form className="space-y-3">
            <input
              ...
              style={{ color: fontColor, fontFamily: cardFont, background: cardBg }}
            />
            <input
              type="number"
              placeholder="Phone"
