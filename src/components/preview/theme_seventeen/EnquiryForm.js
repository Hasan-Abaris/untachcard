    ...
    <div className="max-w-md mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
        <input
          ...
          className="w-full px-5 py-4 rounded-xl border border-gray-200 focus:border-purple-500 focus:outline-none text-gray-800 placeholder-gray-400 transition"
        />
        ...
        <textarea
          ...
          className="w-full px-5 py-4 rounded-xl border border-gray-200 focus:border-purple-500 focus:outline-none text-gray-800 placeholder-gray-400 resize-none transition"
        />
        ...
        <button
          ...
          className="w-full sm:w-auto px-10 py-4 bg-purple-600 text-white font-medium rounded-full hover:bg-purple-700 focus:outline-none transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Send
        </button>
      </div>
