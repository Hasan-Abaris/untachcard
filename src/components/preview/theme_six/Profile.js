...
const ProfileCard = ({ data }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg max-w-md mx-auto text-black overflow-hidden relative font-sans">
      {/* Header */}
      <div className=" h-32 relative">
        <div className="absolute top-2 left-2 px-3 py-1 text-xs rounded-lg">
          Views: {data?.views || 0}
        </div>
