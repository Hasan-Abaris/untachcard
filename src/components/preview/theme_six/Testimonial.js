...
function Testimonial() {
  ...
  return (
    <div className="flex justify-center items-center  bg-gray-100">
      <div className="card p-4 m-0 max-w-md w-full  text-black">
              ...
              >
                <div className="pb-3">
                  <div className="product-item">
                    ...
                    <div className="product-details text-center mt-3 text-black">
                      ...
                      <div className="text-small text-black mt-2">
                        {testimonial.text}
                      </div>
                    </div>
                  </div>
